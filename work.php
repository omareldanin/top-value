...
$query1 = 'SELECT * FROM workes WHERE advantage = "تطبيقات الجوال"';
$result1 = mysqli_query($conn , $query1);
$type1 = mysqli_fetch_all($result1 ,MYSQLI_ASSOC);
$query2 = 'SELECT * FROM workes WHERE advantage = "تطبيقات الويب "';
$result2 = mysqli_query($conn , $query2);
$type2 = mysqli_fetch_all($result2 ,MYSQLI_ASSOC);
$query3 = 'SELECT * FROM workes WHERE advantage = "مواقع الويب"';
$result3 = mysqli_query($conn , $query3);
$type3 = mysqli_fetch_all($result3 ,MYSQLI_ASSOC);
$query4 = 'SELECT * FROM workes WHERE advantage = "تطبيقات سطح المكتب"';
...
<html lang="ar">
  <head>
    ...
    <link rel="stylesheet" href="./scss/css/our-work.css" />
  ...
  <body>
    ...
    <section class="our-works">
      <div class="container">
        ...
        <div class="filters">
          <a data-work="programming"<?php if($type == 1){ ?>class="center active"<?php }else{?>class="center"<?php }?> >تطبيقات الجوال</a>
          <a data-work="web" <?php if($type == 2){ ?>class="center active"<?php }else{?>class="center"<?php }?>>تطبيقات الويب</a>
          <a data-work="web1" <?php if($type == 3){ ?>class="center active"<?php }else{?>class="center"<?php }?>>مواقع الويب</a>
          <a data-work="desktop" <?php if($type == 4){ ?>class="center active"<?php }else{?>class="center"<?php }?>>تطبيقات سطح المكتب</a>
        </div>
        <div class="works worksContainer">
          <div id="programming"
          <?php if($type == 1){ ?>class="row row-cols-1 row-cols-md-2 row-cols-lg-3 open"<?php }else{?>class="row row-cols-1 row-cols-md-2 row-cols-lg-3"<?php }?>
          >
            ...
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <a href="work-desc.php?workId=<?php echo $type1[$i]['id']?>" class="work">
                ...
                <div class="desc">
                  ...
                  <span><?php echo $type1[$i]['advantage']?></span>
                  <p>
          ...
          <?php if($type == 2){ ?>class="row row-cols-1 row-cols-md-2 row-cols-lg-3 open"<?php }else{?>class="row row-cols-1 row-cols-md-2 row-cols-lg-3"<?php }?>
          >
            ...
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <a href="work-desc.php?workId=<?php echo $type2[$i]['id']?>" class="work">
                ...
                <div class="desc">
                  ...
                  <span><?php echo $type2[$i]['advantage']?></span>
                  <p>
          ...
          <div id="web1" 
          <?php if($type == 3){ ?>class="row row-cols-1 row-cols-md-2 row-cols-lg-3 open"<?php }else{?>class="row row-cols-1 row-cols-md-2 row-cols-lg-3"<?php }?>
          >
            ...
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <a href="work-desc.php?workId=<?php echo $type3[$i]['id']?>" class="work">
                ...
                <div class="desc">
                  ...
                  <span><?php echo $type3[$i]['advantage']?></span>
                  <p>
            ...
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <a href="work-desc.php?workId=<?php echo $type4[$i]['id']?>" class="work">
                ...
                <div class="desc">
                  ...
                  <span><?php echo $type4[$i]['advantage']?></span>
                  <p>
