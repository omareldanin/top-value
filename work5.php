...
$query1 = 'SELECT * FROM workes WHERE advantage = "وثائقيات"';
$result1 = mysqli_query($conn , $query1);
$type1 = mysqli_fetch_all($result1 ,MYSQLI_ASSOC);
$query2 = 'SELECT * FROM workes WHERE advantage = "إعلانات"';
$result2 = mysqli_query($conn , $query2);
$type2 = mysqli_fetch_all($result2 ,MYSQLI_ASSOC);
$query3 = 'SELECT * FROM workes WHERE advantage = "شعر و خواطر"';
$result3 = mysqli_query($conn , $query3);
$type3 = mysqli_fetch_all($result3 ,MYSQLI_ASSOC);
$query4 = 'SELECT * FROM workes WHERE advantage = "كتب صوتية"';
    ...
    <section class="our-works1">
      <div class="container">
        <div class="head">
          ...
          <p>الاعمال -<span>التعليق الصوتي</span></p>
        </div>
        <div class="filters">
          <a data-work="documentaries" <?php if($type == 1){ ?>class="center active"<?php }else{?>class="center"<?php }?>>وثائقيات</a>
          <a data-work="adds" <?php if($type == 2){ ?>class="center active"<?php }else{?>class="center"<?php }?>>إعلانات</a>
          <a data-work="Poetry" <?php if($type == 3){ ?>class="center active"<?php }else{?>class="center"<?php }?>>شعر و خواطر</a>
          <a data-work="books" <?php if($type == 4){ ?>class="center active"<?php }else{?>class="center"<?php }?>>كتب صوتية</a>
        </div>
        <div class="works1 worksContainer">
          <div id="documentaries"<?php if($type == 1){ ?> class="row row-cols-1 row-cols-lg-2 open"<?php }else{?> class="row row-cols-1 row-cols-lg-2"<?php }?>>
          ...
          <div id="adds" <?php if($type == 2){ ?> class="row row-cols-1 row-cols-lg-2 open"<?php }else{?> class="row row-cols-1 row-cols-lg-2"<?php }?>>
          ...
          <div id="Poetry" <?php if($type == 3){ ?> class="row row-cols-1 row-cols-lg-2 open"<?php }else{?> class="row row-cols-1 row-cols-lg-2"<?php }?>>
          ...
          <div id="books" <?php if($type == 4){ ?> class="row row-cols-1 row-cols-lg-2 open"<?php }else{?> class="row row-cols-1 row-cols-lg-2"<?php }?>>
