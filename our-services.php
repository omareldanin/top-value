...
<html lang="ar">
  <head>
    ...
    <link rel="stylesheet" href="./scss/css/our-services.css" />
    ...
    <title>Top Value - our services</title>
  </head>
        ...
        <div class="services">
          <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
            <div class="col wow slideInRight" data-wow-delay="0.1s">
              <a href="work.php?type=1" class="service">
                <div class="icon">
...
و مواقع الويب وتطبيقات سطح المكتب .
            ...
            <div class="col wow slideInRight" data-wow-delay="0.2s">
              <a href="work5.php?type=1" class="service">
                <div class="icon">
                  <img
                ...
                <div class="desc">
                  ...
                  <p>
                  تصميم شعارات وهويات بصرية و تصاميم سوشيال ميديا وتصميم كتب وعروض تقديمية وتصميم مطبوعات بأنواعها .
                  </p>
                </div>
              </a>
            </div>
            <div class="col wow slideInRight" data-wow-delay="0.3s">
              <a href="work1.php?type=1" class="service">
                <div class="icon">
                  <img
                    src="./images/fill.svg"
                    class="wow bounce"
                ...
                <div class="desc">
                  <h3>التصميم</h3>
                  <p>
                  نقدم خدمة التعليق الصوتي للوثائقيات و والإعلانات و الشعر و الخواط و الكتب الصوتية .
                  </p>
                </div>
              </a>
            </div>
            <div class="col wow slideInRight" data-wow-delay="0.1s">
              <a href="work4.php?type=1" class="service">
                <div class="icon">
                  <img
                ...
                <div class="desc">
                  <h3>المونتاج</h3>
                  <p>نقدم من خلال هذه الخدمة مونتاج فيديو و وايت بورد و موشن غرافيك وأنترو .
                  </p>
                </div>
              </a>
            </div>
            <!-- <div class="col wow slideInRight" data-wow-delay="0.2s">
              <a href="work4.php" class="service">
                <div class="icon">
                  <img
                ...
                <div class="desc">
                  <h3>تقديم البرامج</h3>
                  <p>
                    نتأكد من تنفيذ الخدمات و تسليمها بشكل يرضي العميل و يجعله
                    سعيدا جدًا بالخدمات التي قُدمت إليه .
                  </p>
                </div>
              </a>
            </div> -->
    ...
    <svg display="none">
      <symbol width="24" height="24" viewBox="0 0 90 90" id="dsplay-code">
        <path
          id="display-code"
      ...
      <symbol width="24" height="24" viewBox="0 0 90 90" id="fill">
        <path
          id="fill"
      ...
      <symbol width="24" height="24" viewBox="0 0 90 90" id="TV">
      ...
      <symbol width="24" height="24" viewBox="0 0 90 90" id="video">
