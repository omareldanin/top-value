...
<html lang="ar">
  <head>
    ...
    <link rel="stylesheet" href="./scss/css/work-video.css" />
    ...
    <section class="work-video">
      <div class="container">
        <div class="head">
          ...
          <p>الاعمال - اسم القسم -<span>اسم العمل الفرعي</span></p>
        </div>
        <div class="header">
        ...
        <div class="video">
          ...
          <video>
            <source src="./images/Palm_Trees.mp4" type="video/mp4"></source>
          </video>
        </div>
