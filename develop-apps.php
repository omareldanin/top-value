...
<html lang="ar">
  <head>
    ...
    <link rel="stylesheet" href="./scss/css/develop-apps.css" />
    ...
    <title>Top Value - develop apps</title>
  </head>
  <body>
    ...
    <section class="our-works">
      <div class="container">
        <div class="head">
          <h1><?php echo $selectedServices[0]["titel"]?></h1>
          <p>
        ...
        <div class="how-to-work">
          <div class="head">
            <h2>كيف نعمل</h2>
            <p>
              تجمع توب فاليو بين الإبداع المهني والقدرات الفنية والبعد التسويقي
              لتقدم لك الخدمات التي تحقق النجاح لشركتك أو مؤسستك .
            </p>
          </div>
          <div class="row row-cols-1 row-cols-lg-2">
            <div class="col">
              <div>
                <span class="center">01</span>
                <h3>التواصل</h3>
                <p>
                  تم في هذه المرحلة الاجتماع مع العميل لفهم احتيجاته ورغباته من
                  الخدمة المطلوبة.
                </p>
              </div>
            </div>
            <div class="col">
              <div>
                <span class="center">02</span>
                <h3>بدء العمل</h3>
                <p>
                  يتم في هذه المرحلة تحويل أفكار وتطلعات العميل الى خدمات جاهزة.
                </p>
              </div>
            </div>
            <div class="col">
              <div>
                <span class="center">03</span>
                <h3>الجودة</h3>
                <p>
                  في هذه المرحلة تتم عمليات الجودة والاختبارات من قبل مختصين ذو
                  خبرة عالية.
                </p>
              </div>
            </div>
            <div class="col">
              <div>
                <span class="center">04</span>
                <h3>التسليم</h3>
                <p>
                  في هذه المرحلة يتم تسليم العميل خدمته وشرحها له بملف مرفق .
                </p>
              </div>
            </div>
          </div>
          <div class="bottom">
            ...
            switch ($Services) {
              case 1:?>
                <a href='work.php?type=1'>شاهد أعمالنا في <?php echo $selectedServices[0]['titel']?></a>
                <?php break;?>
                <?php case 2: ?>
                <a href='work5.php?type=1'>شاهد أعمالنا في <?php echo $selectedServices[0]['titel']?></a>
                <?php break;?>
                <?php case 3: ?>
                <a href='work1.php?type=1'>شاهد أعمالنا في <?php echo $selectedServices[0]['titel']?></a>
                <?php break;?>
                <?php case 4: ?>
                <a href='work4.php?type=1'>شاهد أعمالنا في <?php echo $selectedServices[0]['titel']?></a>
                <?php break;?>
                <?php case 5: ?>
                <a href='work4.php?type=1'>شاهد أعمالنا في <?php echo $selectedServices[0]['titel']?></a>
                <?php break;?>
                <?php } ?>
            <button onclick="toggleRequestForm()">اطلب الخدمة الان</button>
          </div>
        </div>
      </div>
    </section>
