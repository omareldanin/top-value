...
<head>
    ...
    <link rel="stylesheet" href="./scss/css/work-desc.css" />
        ...
        <div class="container">
            <div class="head">
                <div class="image wow fadeInRight">
                    <img src="./images/workes/<?php echo $selectedWorker[0]['icon']?>" />
                </div>
                <div class="desc wow fadeInUp" data-wow-delay="0.3s">
                    <h3><?php echo $selectedWorker[0]['titel']?></h3>
                    <p>
                        <?php echo $selectedWorker[0]['sup_titel']?>
                    </p>
                </div>
                <?php if($selectedWorker[0]['advantage'] =="تطبيقات الجوال" ) { ?>
                <?php if($selectedWorker[0]['type'] =="andriod"){ ?>
                  <div class="icons">
                    <a href="<?php echo $selectedWorker[0]['android_link']?>" class="icon center">
                        <img class="wow bounce" data-wow-duration="1s" data-wow-delay="0.5s"
                            src="./images/3 – 2/Group 72042.svg" />
                    </a>
                </div>
                <?php }else if($selectedWorker[0]['type'] =="andriod&ios"){?>
                  <div class="icons">
                    <a href="<?php echo $selectedWorker[0]['android_link']?>" class="icon center">
                        <img class="wow bounce" data-wow-duration="1s" data-wow-delay="0.5s"
                            src="./images/3 – 2/Group 72042.svg" />
                    </a>
                    <a href="<?php echo $selectedWorker[0]['ios_link']?>" class="icon center">
                        <img class="wow bounce" data-wow-duration="1s" data-wow-delay="1s"
                            src="./images/3 – 2/Group 58160.svg" />
                    </a>
                </div>
                <?php }else{?>
                <div class="icons">
                ...
                <?php }?>
                <?php }else if($selectedWorker[0]['advantage'] =="تطبيقات الويب"){?>
                  <div class="icons">
                    <a href="<?php echo $selectedWorker[0]['android_link']?>" class="icon center">
                        <img class="wow bounce" data-wow-duration="1s" data-wow-delay="0.5s"
                            src="./images/3/laptop.svg" />
                    </a>
                </div>
                <?php }?>
