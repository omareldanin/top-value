...
<html lang="ar">
  <head>
    ...
    <link rel="stylesheet" href="./scss/css/work2.css" />
  ...
  <body>
    ...
    <section class="work-desc">
      <div class="container">
        ...
        <div class="header">
          <div class="work3Image wow fadeInRight">
        ...
        <div class="work-pages">
          <?php foreach ($Workerphoto as $photo) {?>
            <div class="page3">
              <img src="./images/workes/<?php echo $photo['name']?>"/>
            </div>
            <?php }?>
          <div class="page3">
            <img  style="height: 100%;width: 100%;"src="./images/workes/<?php echo $selectedWorker[0]['sup_icon']?>"/>
          </div>
        </div>
        <div class="bottom">
