            ...
            <div class="links">
                ...
                <div class="buttons">
                    <button class="ask-service" onclick="toggleRequestForm()">
                        <a><img src="./images/tool-box/tool-box.png" />
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="info">
                        ...
                        <button class="wow fadeInUp" data-wow-delay=".9s" onclick="toggleRequestForm()">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide wow">
                                <a href="develop-apps.php?Services_id=1" class="service">
                                    ...
                                    <div class="desc">
                                        <h3>البرمجة</h3>
                                        <p>
                                            برمجة تطبيقات الجوال و تطبيقات الويب
                                            و مواقع الويب وتطبيقات سطح المكتب .
                            ...
                            <div class="swiper-slide wow">
                                <a href="develop-apps.php?Services_id=2" class="service">
                                    <div class="icon">
                                        <img src="./images/voice-recorder.svg" class="wow bounce" data-wow-delay="1s" />
                                    </div>
                                    <div class="desc">
                                        <h3>التعليق الصوتي</h3>
                                        <p>
                                            نقدم خدمة التعليق الصوتي للوثائقيات و والإعلانات و الشعر و الخواط و الكتب
                                            الصوتية .
                                        </p>
                                    </div>
                                </a>
                            ...
                            <div class="swiper-slide wow">
                                <a href="develop-apps.php?Services_id=3" class="service">
                                    <div class="icon">
                                        <img src="./images/fill.svg" class="wow bounce" data-wow-delay="2s" />
                                    </div>
                                    <div class="desc">
                                        <h3>التصميم</h3>
                                        <p>
                                            تصميم شعارات وهويات بصرية و تصاميم سوشيال ميديا وتصميم كتب وعروض تقديمية
                                            وتصميم مطبوعات بأنواعها .</p>
                                    </div>
                                </a>
                            </div>
                            <div class="swiper-slide wow">
                                <a href="develop-apps.php?Services_id=4" class="service">
                                    <div class="icon">
                                        <img src="./images/video.svg" class="wow bounce" data-wow-delay="3s" />
                                    </div>
                                    <div class="desc">
                                        <h3>المونتاج</h3>
                                        <p>نقدم من خلال هذه الخدمة مونتاج فيديو و وايت بورد و موشن غرافيك وأنترو .</p>
                                    </div>
                                </a>
                            </div>
                        ...
                        <a <?php if($worke['advantage'] =="تطبيقات الويب") { ?>
                            ...
                            <div class="image center">
                                <div class="work-image">
                                    <img class="work-image" style="height: 100%;width: 100%;"
                                        src="./images/workes/<?php echo $worke['icon']?>" />
                                </div>
                                <?php if($worke['advantage'] =="تطبيقات الجوال" ) { ?>
                                <?php if($worke['type'] =="andriod"){ ?>
                                <div class="icons">
                                    <div class="icon center">
                                        <img src="./images/3/Group 72042.svg" />
                                    </div>
                                </div>
                                <?php }else if($worke['type'] =="andriod&ios"){?>
                                <div class="icons">
                                    <div class="icon center">
                                ...
                                <?php }?>
                                <?php }else if($worke['advantage'] =="تطبيقات الويب"){?>
                                <div class="icons">
                                    <div class="icon center">
                                        ...
                                        <div class="review">
                                            ...
                                            <div class="info">
                                                <div class="profile" style="height: 100%;width: 100%; ">
                                                    <img src="./images/clint/<?php echo $clint['image']?>" alt="" />
                                                    <div class="name">
                        ...
                        <div class="col-lg-6 center wow fadeInLeft" data-wow-delay=".8s">
                            <div class="users">
                                ...
                                <div class="user<?php echo $i+1?>">
                                    <img src="./images/clint/<?php echo $clints[$i]['image']?>" alt="" />
                                </div>
                                <?php }?>
                            </div>
        ...
        <symbol width="24" height="24" viewBox="0 0 80.345 80.599" id="TV">
            <g id="Live_TV" data-name="Live TV" transform="translate(-3.75 -3.514)">
                <path id="Path_104669" data-name="Path 104669"
                    ...
                    transform="translate(7.669 9.366)" fill="#b8babf" stroke="#fff" stroke-width="0.5" />
                <path id="Path_104670" data-name="Path 104670"
                    ...
                    transform="translate(0 0)" fill="#b8babf" stroke="#fff" stroke-width="0.5" />
            </g>
        </symbol>
            ...
            <g id="video" transform="translate(0.5 0.5)">
                <g id="object_3_">
                    <g id="Group_72566" data-name="Group 72566">
                        <path id="Path_102587" data-name="Path 102587"
                            ...
                            fill="#b8babf" stroke="#b8babf" stroke-width="1" />
                    </g>
                    <g id="Group_72567" data-name="Group 72567" transform="translate(27.298 32.741)">
                        <path id="Path_102588" data-name="Path 102588"
                            ...
                            transform="translate(-183.965 -220.647)" fill="#b8babf" stroke="#b8babf" stroke-width="1" />
                    </g>
                </g>
            </g>
        </symbol>
            ...
            <g id="voice-recorder" transform="translate(-10.118 -29.434)">
                <g id="Group_72551" data-name="Group 72551" transform="translate(13.46 42.701)">
                    <g id="Group_72550" data-name="Group 72550">
                        <path id="Path_102579" data-name="Path 102579"
                ...
                <g id="Group_72553" data-name="Group 72553" transform="translate(16.739 29.584)">
                    <g id="Group_72552" data-name="Group 72552">
                        <path id="Path_102580" data-name="Path 102580"
                            ...
                            transform="translate(-179.522 -29.584)" stroke="#b8babf" stroke-width="0.3" />
                    </g>
                </g>
                ...
                <g id="Group_72563" data-name="Group 72563" transform="translate(10.268 32.906)">
                    <g id="Group_72562" data-name="Group 72562" transform="translate(0 0)">
                        <path id="Path_102585" data-name="Path 102585"
