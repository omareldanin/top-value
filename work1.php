...
$query1 = 'SELECT * FROM workes WHERE advantage = "هويات بصرية"';
$result1 = mysqli_query($conn , $query1);
$type1 = mysqli_fetch_all($result1 ,MYSQLI_ASSOC);
$query2 = 'SELECT * FROM workes WHERE advantage = "سوشيال ميديا"';
$result2 = mysqli_query($conn , $query2);
$type2 = mysqli_fetch_all($result2 ,MYSQLI_ASSOC);
$query3 = 'SELECT * FROM workes WHERE advantage = "عروض تقديمية"';
$result3 = mysqli_query($conn , $query3);
$type3 = mysqli_fetch_all($result3 ,MYSQLI_ASSOC);
$query4 = 'SELECT * FROM workes WHERE advantage = "تصميم الكتب"';
...
<html lang="ar">
  <head>
    ...
    <title>Top Value - our works</title>
  </head>
  <body>
    ...
    <section class="our-works1">
      <div class="container">
        <div class="head">
          <h1>أعمالنا</h1>
          <p>الاعمال -<span>التصميم</span></p>
        </div>
        <div class="filters">
          <a data-work="visualIdentities" <?php if($type == 1){ ?>class="center active"<?php }else{?>class="center"<?php }?> >هويات بصرية</a>
          <a data-work="socialMedia" <?php if($type == 2){ ?>class="center active"<?php }else{?>class="center"<?php }?>>سوشيال ميديا</a>
          <a data-work="presentations" <?php if($type == 3){ ?>class="center active"<?php }else{?>class="center"<?php }?>>عروض تقديمية</a>
          <a data-work="publicationsDesign" <?php if($type == 4){ ?>class="center active"<?php }else{?>class="center"<?php }?>>تصميم الكتب</a>
        </div>
        <div class="works1 worksContainer">
          <div id="visualIdentities" <?php if($type == 1){ ?>class="row row-cols-1 row-cols-lg-2 open"<?php }else{?>class="row row-cols-1 row-cols-lg-2"<?php }?>>
          <?php for ($i=0; $i < count($type1); $i++) { ?>
            <a href="work2.php?workId=<?php echo $type1[$i]['id']?>" class="work">
          ...
          <div id="socialMedia" <?php if($type == 2){ ?>class="row row-cols-1 row-cols-lg-2 open"<?php }else{?>class="row row-cols-1 row-cols-lg-2"<?php }?>>
          <?php for ($i=0; $i < count($type2); $i++) { ?>
            <a href="work2.php?workId=<?php echo $type2[$i]['id']?>" class="work">
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <div class="work">
                <div class="image">
          ...
          <div id="presentations" <?php if($type == 3){ ?>class="row row-cols-1 row-cols-lg-2 open"<?php }else{?>class="row row-cols-1 row-cols-lg-2"<?php }?>>
          <?php for ($i=0; $i < count($type3); $i++) { ?>
            <a href="work2.php?workId=<?php echo $type3[$i]['id']?>" class="work">
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <div class="work">
                <div class="image">
          ...
          <div id="publicationsDesign" <?php if($type == 4){ ?>class="row row-cols-1 row-cols-lg-2 open"<?php }else{?>class="row row-cols-1 row-cols-lg-2"<?php }?>>
          <?php for ($i=0; $i < count($type4); $i++) { ?>
            <a href="work2.php?workId=<?php echo $type4[$i]['id']?>" class="work">
            <div class="col wow fadeInRight" data-wow-delay="0.<?php echo $i?>s">
              <div class="work">
                <div class="image">
